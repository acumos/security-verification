...
class LicenseCDSUtil {
   ...
   * @param request
   *  a {@link org.acumos.licensemanager.client.model.ILicenseRequest} object.
   * @param response
   *  a {@link org.acumos.licensemanager.client.model.IErrorResponse} object.
   * @return a {@link java.util.List} object.
   */
  protected static List<MLPRightToUse> getRightToUses(
    final ICommonDataServiceRestClient dataClient,
    final ILicenseRequest request,
    final IErrorResponse response) {
   ...
   *  {@link org.acumos.cds.client.ICommonDataServiceRestClient} object.
   * @param request a
   *  {@link org.acumos.licensemanager.client.model.ILicenseRequest} object.
   * @param response a
   *  {@link org.acumos.licensemanager.client.model.IErrorResponse} object.
   * @return a {@link java.util.List} object.
   */
