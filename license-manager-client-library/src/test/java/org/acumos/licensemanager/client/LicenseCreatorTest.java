...
public class LicenseCreatorTest {
	...
	// TODO test solution with site wide rtu


	@Test
	public void licenseCreator() {
		...
		ICreatedRtu verifyUserRTU = licenseSrvc.createRTU(licenseDownloadRequest);
		...
		licenseDownloadRequest2.setUserId(userId);
	...
	@Test()
	public void invalidNoRequestArgumentTest(){
		CommonDataServiceRestClientMockImpl client = new CommonDataServiceRestClientMockImpl("url", "user", "pass");
		ILicenseCreator licenseSrvc = new LicenseCreator(client);
	...
	@Test()
	public void invalidNoSolutionIdArgumentTest(){
		CommonDataServiceRestClientMockImpl client = new CommonDataServiceRestClientMockImpl("url", "user", "pass");
		ILicenseCreator licenseSrvc = new LicenseCreator(client);
	...
	@Test()
	public void invalidNoUserIdArgumentTest(){
		CommonDataServiceRestClientMockImpl client = new CommonDataServiceRestClientMockImpl("url", "user", "pass");
		ILicenseCreator licenseSrvc = new LicenseCreator(client);
		CreateRTURequest creationrequest = new CreateRTURequest();
