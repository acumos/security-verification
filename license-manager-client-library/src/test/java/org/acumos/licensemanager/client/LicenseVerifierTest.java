...
public class LicenseVerifierTest {
	...
	@Test
	public void licenseVerifierUserOnly() throws InterruptedException, ExecutionException {
		...
		IVerifyLicenseRequest licenseDownloadRequest = new VerifyLicenseRequest(LicenseAction.deploy, solution.getSolutionId(),
	...
	@Test
	public void licenseVerifierSiteWide() throws InterruptedException, ExecutionException {
		...
		ILicenseVerifier licenseSrvc = new LicenseVerifier(client);
		IVerifyLicenseRequest licenseDownloadRequest = new VerifyLicenseRequest(LicenseAction.deploy, "dummysolutionid",
				"dummyuserid");
		licenseDownloadRequest.addAction(LicenseAction.download);
	...
	@Test
	public void licenseVerifierInvalidTests(){
		...
		IVerifyLicenseRequest licenseDownloadRequest = new VerifyLicenseRequest();
	...
	@Test
	public void licenseVerifierNoRequest(){
	...
	@Test
	public void licenseVerifierNoSolution(){

		CommonDataServiceRestClientMockImpl dataClient = new CommonDataServiceRestClientMockImpl("url", "user", "pass");
		LicenseVerifier licenseVerifier = new LicenseVerifier(dataClient);
		IVerifyLicenseRequest licenseDownloadRequest = new VerifyLicenseRequest();
		licenseDownloadRequest.setSolutionId("dummysolution");
		licenseDownloadRequest.setUserId("dummyUser");
